...
public class VerticalStepViewIndicator extends View {
    ...
    private void init() {
        ...
        mCompleteIcon = ContextCompat.getDrawable(getContext(), R.drawable.ic_completed_status);//已经完成的icon
        mAttentionIcon = ContextCompat.getDrawable(getContext(), R.drawable.ic_current_status);//正在进行的icon
        mDefaultIcon = ContextCompat.getDrawable(getContext(), R.drawable.ic_uncompleted_status);//未完成的icon
